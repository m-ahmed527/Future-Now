    ...
    <div class="feedback-wrapper">
        <div class="row">
            <div class="col-lg-5 col-sm-12">
                <form action="{{route('plan.store')}}" method="POST" class="feedback-form">
                    @csrf
                    ...
                    <div class="animated-input">
                        <textarea name="description" id="" class="feedback-text" cols="30" rows="10">{{old('description')}}</textarea>
            ...
            $(document).on('click', '#page_numbers', function(e) {
                ...
                for (i = 1; i <= pages; i++) {
                    $('.pages_section').append('<div style="margin-bottom:40px;">' +
                        '</div><h4>Package' + i +
                        '</h4>' + '<div class="animated-input"><input type="text" name="package[]" required><label>Package Name</label></div>'
                        );
                }
