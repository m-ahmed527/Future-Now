            ...
            <div class="col-10 mx-auto">
                <div class="login-form p-login-page mb-24">
                    <div class="form-head d-flex flex-column justify-content-center align-items-center">
                        <h1 class="form-top-heading">Edit Password</h1>
                        <p class="form-bottom-heading">Set new password for your account.</p>
                    </div>
                    <form action="./login.php" class="form">
                        <label for="#" class="label-field mt-4 ">Enter password *</label>
                        <input type="password" placeholder="Enter your password" required class="input-field mt-2 mb-3 py-3 px-4">
                        <label for="#" class="label-field">Enter new password *</label>
                        <input type="password" placeholder="Enter your new password" required class="input-field mt-2 mb-3 py-3 px-4">
                        <label for="#" class="label-field">Confirm password *</label>
                        <input type="password" placeholder="Confirm your password" required class="input-field mt-2 mb-3 py-3 px-4">
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body text-center">
                                        ...
                                        <h4 class="modal-text">Password changed successfull!</h4>
                                    </div>
